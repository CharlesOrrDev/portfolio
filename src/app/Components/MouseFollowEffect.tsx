    ...
    >
      ...
      <div
        className={`w-[50px] h-[50px] col-start-2 row-start-2 p-[2px] pr-[1px] pb-[1px] rounded-tl-full
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-tl from-green-500 via-green-950 to-green-500" : "bg-gradient-to-tl from-white via-gray-700 to-white"}
        `}
      >
      ...
      <div
        className={`w-[50px] h-[50px] col-start-3 row-start-2 p-[2px] pl-[1px] pb-[1px] rounded-tr-full
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-tr from-green-500 via-green-950 to-green-500" : "bg-gradient-to-tr from-white via-gray-700 to-white"}
        `}
      >
      ...
      <div
        className={`w-[50px] h-[50px] col-start-2 row-start-3 p-[2px] pr-[1px] pt-[1px] rounded-bl-full
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-bl from-green-500 via-green-950 to-green-500" : "bg-gradient-to-bl from-white via-gray-700 to-white"}
        `}
      >
      ...
      <div
        className={`w-[50px] h-[50px] col-start-3 row-start-3 p-[2px] pl-[1px] pt-[1px] rounded-br-full
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-br from-green-500 via-green-950 to-green-500" : "bg-gradient-to-br from-white via-gray-700 to-white"}
        `}
      >
      ...
      <div
        className={`w-[100vw] h-[1px] self-end col-start-1 row-start-2
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-r from-green-950 via-green-500 to-green-950" : "bg-gradient-to-r from-gray-700 via-gray-50 to-gray-700"}
        `}
      />

      <div
        className={`w-[100vw] h-[1px] self-end col-start-4 row-start-2
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-l from-green-950 via-green-500 to-green-950" : "bg-gradient-to-l from-gray-700 via-gray-50 to-gray-700"}
        `}
      />
      ...
      <div
        className={`w-[1px] h-[100vh] ml-[49px] col-start-2 row-start-1
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-b from-green-950 via-green-500 to-green-950" : "bg-gradient-to-b from-gray-700 via-gray-50 to-gray-700"}
        `}
      />
      ...
      <div
        className={`w-[1px] h-[100vh] col-start-2 row-start-4 ml-[49px]
          ${hoveringEnter || hoveringButton ? "bg-gradient-to-t from-green-950 via-green-500 to-green-950" : "bg-gradient-to-t from-gray-700 via-gray-50 to-gray-700"}
        `}
      />
